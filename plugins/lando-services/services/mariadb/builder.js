...
module.exports = {
  ...
  config: {
    version: '10.3',
    supported: ['10.6', '10.5', '10.4', '10.3', '10.2'],
    pinPairs: {
      '10.6': 'bitnami/mariadb:10.6',
      '10.5': 'bitnami/mariadb:10.5',
      '10.4': 'bitnami/mariadb:10.4',
      '10.3': 'bitnami/mariadb:10.3',
      '10.2': 'bitnami/mariadb:10.2',
    },
