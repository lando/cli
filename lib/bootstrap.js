...
const engineRunner = (config, command) => (argv, lando) => {
  ...
  const utils = require('./../plugins/core/lando-tooling/lib/utils');
  const buildTask = require('./../plugins/core/lando-tooling/lib/build');
  require('./../plugins/core/lando-events/app')(app, lando);
