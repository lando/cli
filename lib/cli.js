...
module.exports = class Cli {
  ...
  defaultConfig(appConfig = {}) {
    ...
    // and we define a separate section for cli stuff
    const cli = {
      version: require(path.join(srcRoot, 'package.json')).version,
      entrypoint,
      bin: _.get(process, 'mainModule.filename', entrypoint),
      packaged,
      path: _.get(process, 'mainModule.path', path.dirname(entrypoint)),
    };
    ...
    return {
      ...
      fatcore: fs.existsSync(path.join(__dirname, '..', 'FATCORE')),
