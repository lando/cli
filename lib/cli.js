...
module.exports = class Cli {
  ...
  defaultConfig(appConfig = {}) {
    ...
    return {
      ...
      pluginDirs: [
        // src locations
        {path: srcRoot, subdir: 'plugins'},
        {path: path.join(srcRoot, 'node_modules', '@lando', 'core'), subdir: 'plugins', namespace: '@lando'},
        {path: path.join(srcRoot, 'node_modules', '@lando', 'core'), subdir: '.', namespace: '@lando'},

        // system locations
        {path: path.join(getSysDataPath('lando'), '@node_modules', '@lando', 'core'), subdir: '.', namespace: '@lando', type: 'system-core'},
        {path: path.join(getSysDataPath('lando'), '@node_modules', '@lando', 'core'), subdir: 'plugins', namespace: '@lando', type: 'system-core'},
        {path: path.join(getSysDataPath('lando'), '@node_modules', '@lando'), subdir: '.', namespace: '@lando', type: 'system-lando'},
        {path: path.join(getSysDataPath('lando')), subdir: 'plugins', type: 'system'},

        // user locations
        {path: path.join(this.userConfRoot, 'plugins', '@lando', 'core'), subdir: '.', namespace: '@lando', type: 'user-core'},
        {path: path.join(this.userConfRoot, 'plugins', '@lando', 'core'), subdir: 'plugins', namespace: '@lando', type: 'user-core'},
        {path: path.join(this.userConfRoot, 'plugins', '@lando'), subdir: '.', namespace: '@lando', namespace: '@lando', type: 'user-lando'},
