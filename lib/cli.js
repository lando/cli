...
module.exports = class Cli {
  ...
  defaultConfig(appConfig = {}) {
    ...
    return {
      ...
      command: this.argv(),
      domain: 'lndo.site',
      disablePlugins: ['@lando/core-next'],
      experimental: false,
      ...
      pluginDirs: [
        ...
        {path: path.join(srcRoot, 'node_modules', '@lando', 'core'), subdir: 'plugins'},
        ...
        {path: path.join(getSysDataPath('lando'), '@node_modules', '@lando', 'core'), subdir: 'plugins', type: 'system-core'},
        {path: path.join(getSysDataPath('lando'), '@node_modules', '@lando'), subdir: '.', type: 'system-lando'},

        // user locations
        {path: this.userConfRoot, subdir: 'plugins', type: 'user'},
        {path: path.join(this.userConfRoot, 'plugins', '@lando', 'core'), subdir: 'plugins', type: 'user-core'},
  ...
  parseToYargs({command, describe, options = {}, run = {}, level = 'app'}, config = {}) {
    const handler = argv => {
      ...
      // @NOTE: we _also_ need this here to make sure task.run is available in lando.tasks
